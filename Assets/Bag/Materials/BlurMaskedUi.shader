Shader "Custom/BLUR MaskedUI" {
    Properties {
        _Size ("Blur", Range(0, 30)) = 1
        [HideInInspector] _MainTex ("Masking Texture", 2D) = "white" {}
		_ColorMaxRange ("Color Max Range", Range(0, 30))= 1.7
            ...
            */
            ...
            {          
                ...
                {   
                    ...
                    half4 blurred = half4(sum.r * _MultiplyColor.r + _AdditiveColor.r, 
                                        sum.g * _MultiplyColor.g + _AdditiveColor.g, 
                                        sum.b * _MultiplyColor.b + _AdditiveColor.b, 
                                        tex2D(_MainTex, i.uvmain).a);
                    return lerp(sum, blurred, clamp(_Size / _ColorMaxRange, 0, 1));
                }
                ENDCG
            }
